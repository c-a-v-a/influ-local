...
<div class="flex w-5/6 md:w-4/5 sm:w-3/4 flex-col p-8">
	{#if users.length > 0}
		<div class=" mt-12 flex w-full flex-col">
			<div class=" flex flex-col px-1 sm:px-8 lg:px-10">
				<h1 class="text-4xl text-gray-600 font-light mb-10">
					Zgłoszenia na ofertę "{influArr.name}"
				</h1>
	...
	{:else}
		<div class=" w-full h-full flex justify-center items-center">
			<h1 class="text-4xl text-gray-600 font-light">Brak zgłoszeń na ofertę "{influArr.name}"</h1>
		</div>
	{/if}
</div>
